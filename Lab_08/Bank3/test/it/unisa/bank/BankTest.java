...
public class BankTest {
    ...
    public void depositNegativeTest(){
        Bank b = new Bank();
        BankAccount account = new BankAccount("Sasa",100);
        b.addAccount(account);
        b.deposit(account.getAccountNumber(),-10);
    }

    @Test(expected = IllegalArgumentException.class)
    public void withdramMoreMoneyTest(){
        Bank b = new Bank();
        BankAccount account = new BankAccount("Sasa",20);
        b.addAccount(account);
        b.withdraw(account.getAccountNumber(),50);
    }
}